...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("naidahub")
                .setEventHubName("naidaevent")
                .setSasKeyName("Endpoint=sb://naidahub.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=phtGAPVOyPZAj7w9aXv5OXX8hqCHBnGDw7oVx2t9Tks=")
                .setSasKey("phtGAPVOyPZAj7w9aXv5OXX8hqCHBnGDw7oVx2t9Tks=");
